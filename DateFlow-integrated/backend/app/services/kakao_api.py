...
# 카카오 카테고리 그룹 코드 (데이트 코스 관련)
CATEGORY_CODES: dict[str, str] = {
    "카페":    "CE7",   # 카페·브런치·베이커리·루프탑카페
    "음식점":  "FD6",   # 한식·일식·중식·양식·이자카야·와인바 등
    "문화시설": "CT1",  # 영화관·박물관·미술관·갤러리·공연장·팝업공간
    "관광명소": "AT4",  # 공원·놀이공원·아쿠아리움·야경·수목원·전망대
    "숙박":    "AD5",   # 호텔·펜션·리조트·풀빌라·글램핑
    "쇼핑":    "MT1",   # 백화점·복합쇼핑몰·아울렛
}
...
async def search_by_category(
    ...
    params = {
        ...
        "size": min(size, 15),  # 카테고리 검색 API 최대 15
        "sort": "accuracy",
    }
    async with httpx.AsyncClient(timeout=10.0) as client:
